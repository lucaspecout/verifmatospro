...
class EventNode(Base):
    ...
    source_lot_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
    source_lot_name: Mapped[str | None] = mapped_column(String(120), nullable=True)
    source_lot_color: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ...
    restock_note: Mapped[str | None] = mapped_column(Text, nullable=True)
    restock_author: Mapped[str | None] = mapped_column(String(80), nullable=True)
    restock_updated_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
